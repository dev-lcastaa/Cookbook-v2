...
(1, 'Spaghetti Carbonara', 'Spaghetti, Eggs, Pancetta, Parmesan, Pepper', 'Boil pasta. Cook pancetta. Mix eggs and cheese. Combine.'),
(2, 'Tacos', 'Tortillas, Beef, Lettuce, Tomato, Cheese', 'Cook beef. Assemble tacos with ingredients.'),
(3, 'Grilled Cheese Sandwich', 'Bread, Cheese, Butter', 'Butter bread. Place cheese. Grill until golden.');
